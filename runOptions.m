...
while optionsFile.doOptions
    ...
    optionsFile.model.opt_config = {'tapas_quasinewton_optim_config','tapas_quasinewton_optim_config','tapas_quasinewton_optim_config','tapas_quasinewton_optim_config'};
    optionsFile.plot(1).plot_fits = @tapas_ehgf_binary_plotTraj;
    optionsFile.plot(2).plot_fits = @tapas_rw_binary_plotTraj;

    modelSpace = struct();

    optionsFile.fileName.rawFitFile = {'eHGFFit_3lvl','eHGFFit_2lvl','RWFit','VKFFit'}; 
